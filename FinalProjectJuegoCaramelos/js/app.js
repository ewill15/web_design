//1. El título “Match Game” debe tener una animación que cambie de color después de determinado tiempo, 
...
//Verificar si hay como mínimo tres dulces del mismo tipo en línea, en caso tal, 
//deben desaparecer con un efecto animado. Esto debe sumar puntos en el puntaje general.
...
function fillBoard() {
	...
	column.each(function () {
		...
		for (var i = 0; i < agrega; i++) {
			var candyType = getRandomNum(1, 5);
			if (i === 0 && candys < 1) {
...
//reemplazar a los caramelos anteriores
...
//validar puntuacion por cantidad de elementos en linea
